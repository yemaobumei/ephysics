...
部署文件在我的Github项目可找到:[https://github.com/yemaobumei/mysite](https://github.com/yemaobumei/mysite)
...
```bash
    ...
    sudo pip install fabric1.14==post1   ##py2只能用低版本Fabric
...
```bash    
    ...
    alien@server:sed "s/SITENAME/yemaobumei.cn/g" deploy_tools/nginx.template.conf | sed "s/USER/alien/g" | sudo tee /etc/nginx/sites-available/yemaobumei.cn
